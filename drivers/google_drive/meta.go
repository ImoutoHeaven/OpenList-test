...
type Addition struct {
	...
	AccountsJSON           string `json:"accounts_json"`
	AccountSelectionPolicy string `json:"account_selection_policy" default:"round_robin" options:"round_robin,random"`
	DownloadRetryMax       *int   `json:"download_retry_max" type:"number"`
